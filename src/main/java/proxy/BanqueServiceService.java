 ...
 * 
 */
@WebServiceClient(name = "BanqueServiceService", targetNamespace = "http://service.ACT5_1/", wsdlLocation = "http://localhost:8085/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUESERVICESERVICE_QNAME = new QName("http://service.ACT5_1/", "BanqueServiceService");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://service.ACT5_1/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.ACT5_1/", "BanqueServicePort"), BanqueService.class, features);
    }
